...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Dashboard:Integrations:Outgoing:Title' => '与外部的 webhook 集成',
	'Dashboard:Integrations:ActionWebhookList:Title' => 'Webhook 类型操作',
));

// Base classes
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	// RemoteApplicationType
	'Class:RemoteApplicationType' => '外部应用',
	...
	'Class:RemoteApplicationConnection' => '外部应用连接',
	...
	// - Fieldsets
	'RemoteApplicationConnection:baseinfo' => '基本信息',
	...
	// ActionWebhook
	'Class:ActionWebhook' => 'Webhook 调用(通用)',
	'Class:ActionWebhook+' => 'Webhook 调用可用于任何应用',
	...
	'Class:ActionWebhook/Attribute:method+' => 'HTTP 请求的方法',
	...
	'Class:ActionWebhook/Attribute:headers' => '头部信息',
	'Class:ActionWebhook/Attribute:headers+' => 'HTTP 请求的头信息,每个必须时1行(例如 "Content-type: application/json")',
...
——在某些情况下$oResponse可以为空(例如发送请求失败)',
	// - Fieldsets
	'ActionWebhook:baseinfo' => '基本信息',
	'ActionWebhook:moreinfo' => '更多信息',
	'ActionWebhook:webhookconnection' => 'Webhook 连接',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	// ActioniTopWebhook
	'Class:ActioniTopWebhook' => ITOP_APPLICATION_SHORT.'webhook 调用',
...
请注意如果设置了此参数,则会忽略"JSON 数据"参数.',
));

// Slack
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	// ActionSlackNotification
	'Class:ActionSlackNotification' => 'Slack 通知',
	'Class:ActionSlackNotification+' => '以 Slack 发送通知',
...
请注意如果设置了此参数,则会忽略"消息"和所有的"附加元素"参数.',
	// - Fieldsets
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:ActionRocketChatNotification' => 'Rocket.Chat 通知',
	'Class:ActionRocketChatNotification+' => '以 Rocket.Chat 发送通知',
...
请注意如果设置了此参数,则会忽略"消息"和所有的"自动程序信息"参数.',
	// - Fieldsets
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:ActionGoogleChatNotification' => 'GoogleChat 通知',
	'Class:ActionGoogleChatNotification+' => '以 GoogleChat 发送通知',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:ActionMicrosoftTeamsNotification+' => '以 Microsoft Teams 发送通知',
	...
	'Class:ActionMicrosoftTeamsNotification/Attribute:theme_color+' => '此消息卡片在 Microsoft Teams 中的高亮颜色,必须是合法的16进制颜色编码(例如FF0000)',
	'Class:ActionMicrosoftTeamsNotification/Attribute:image_url' => '徽章图像',
	'Class:ActionMicrosoftTeamsNotification/Attribute:image_url+' => '在此消息卡片中显示为徽章的图片 URL,为使 Microsoft Teams 能显示,其必须是在互联网可公开访问的',
	'Class:ActionMicrosoftTeamsNotification/Attribute:prepare_payload_callback+' => '筹备载荷数据的 PHP 方法,以用于此 webhook 调用时发送.请在标准选项不够灵活,或者所发送数据必须动态生成时使用.

可以使用2种类型的方法
——来自触发对象自身(如用户请求),必须是公开的.例如$this->XXX($aContextArgs, $oLog, $oAction)
——来自任何PHP类,必须是静态的且公开的.名称必须是合法的全名.例如\SomeClass::XXX($oObject, $aContextArgs, $oLog, $oAction)

请注意如果设置了此参数,则会忽略"标题"、"消息"和所有的"附加元素"参数.',
	// - Fieldsets
