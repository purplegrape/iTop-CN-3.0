...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'itop-oauth-client:Message:MissingToken' => '在使用 OAuth 客户端之前需要提前生成 token',
	'itop-oauth-client:Message:RegenerateToken' => 'Regenerate access token to to take into account the changes~~',
	'itop-oauth-client:Message:TokenCreated' => '已创建 token',
	'itop-oauth-client:Message:TokenRecreated' => 'token 已重新生成',
	'itop-oauth-client:Message:TokenError' => '由于服务端出错,token 生成失败',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', [
	...
	'Class:OAuthClient/Attribute:status/Value:active' => 'token 已生成',
	'Class:OAuthClient/Attribute:status/Value:inactive' => '没有 token',
	...
	'Class:OAuthClient/Attribute:refresh_token' => '刷新 token',
	'Class:OAuthClient/Attribute:refresh_token+' => '',
	'Class:OAuthClient/Attribute:refresh_token_expiration' => '刷新 token 时效',
	'Class:OAuthClient/Attribute:refresh_token_expiration+' => '',
	'Class:OAuthClient/Attribute:token' => 'Access token',
	'Class:OAuthClient/Attribute:token+' => '',
	'Class:OAuthClient/Attribute:token_expiration' => 'token 过期',
