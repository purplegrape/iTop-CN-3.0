...
<div>通过自定义 '.ITOP_APPLICATION.' 还可以获得独特的个性化体验.</div>',
	...
	'UI:Delete:Count_Objects/LinksReferencingTheObjects' => '%1$d 个对象/链接 关联了某个将要被删除的对象',
	'UI:Delete:ReferencesMustBeDeletedToEnsureIntegrity' => '为了保障数据库的完整性, 任何项目之间的关联性会被解除',
