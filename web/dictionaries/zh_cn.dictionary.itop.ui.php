...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:AuditCategory/Attribute:definition_set+' => '定义用于审计对象的 OQL 表达式',
...
<div>通过自定义 '.ITOP_APPLICATION.' 还可以获得独特的个性化体验.</div>',
	...
	'UI:Message:EmptyList:UseSearchForm' => '使用上面的搜索栏, 搜索想要添加的对象.',
	...
	'UI:Error:CannotDeleteBecauseOfDepencies' => '无法删除该对象, 因为必须先完成一些手动操作',
	'UI:Error:CannotDeleteBecauseManualOpNeeded' => '无法删除该对象,必须先完成一些手动操作',
	...
	'UI:Delete:CleaningUpRefencesTo_Object' => '解除所有对 %1$s 的引用...',
	'UI:Delete:CleaningUpRefencesTo_Several_ObjectsOf_Class' => '解除对 %1$d 个 %2$s 的引用...',
	'UI:Delete:Done+' => '做了什么...',
	...
	'UI:Delete:Count_Objects/LinksReferencing_Object' => '一共 %1$d 个对象/链接 引用了 %2$s',
	'UI:Delete:Count_Objects/LinksReferencingTheObjects' => '%1$d 个对象/链接 引用了某个将要被删除的对象',
	'UI:Delete:ReferencesMustBeDeletedToEnsureIntegrity' => '为了保障数据库的完整性, 任何项目之间的引用会被解除',
	'UI:Delete:Consequence+' => '要做什么',
	'UI:Delete:SorryDeletionNotAllowed' => '抱歉, 您无权删除该对象, 请参考上面的详细解释',
	'UI:Delete:PleaseDoTheManualOperations' => '在删除该对象之前, 请先手工完成上述列出的操作',
	'UI:Delect:Confirm_Object' => '请确认是否删除 %1$s.',
	'UI:Delect:Confirm_Count_ObjectsOf_Class' => '请确认是否删除下列 %1$s 个 %2$s .',
	'UI:WelcomeToITop' => '欢迎使用 '.ITOP_APPLICATION_SHORT,
	'UI:DetailsPageTitle' => ITOP_APPLICATION_SHORT.' - %1$s - %2$s 详情',
	'UI:ErrorPageTitle' => ITOP_APPLICATION_SHORT.' - 报错',
	...
	'UI:PageTitle:ObjectCreated' => ITOP_APPLICATION_SHORT.' 对象创建.',
	'UI:Title:Object_Of_Class_Created' => '%1$s - %2$s 已创建.',
	'UI:Apply_Stimulus_On_Object_In_State_ToTarget_State' => '正在 %1$s 对象: %2$s 属性 %3$s 状态变为: %4$s.',
	...
	'UI:UserManagement:User+' => '与该规划相关的用户',
...
当与触发器关联时, 每个行为都有序号, 指定了按照什么样的顺序执行这些操作.</p>',
	...
	'UI:Modify_M_ObjectsOf_Class_OutOf_N' => '正在修改 %1$d 个 %2$s ,共 %3$d 个',
	...
	'UI:Pagination:HeaderSelection' => '共: %1$s 项(已选 %2$s 项).',
	...
	'UI:Display_X_ItemsPerPage_prefix' => '每页',
