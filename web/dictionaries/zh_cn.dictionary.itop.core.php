...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Core:AttributeEncryptFailedToDecrypt' => '** 解密出错 **',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:CMDBChangeOp+' => '某人在某时某刻对某个对象的调整操作',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:SynchroDataSource/Attribute:full_load_periodicity' => '执行频率',
	...
	'Class:SynchroLog/Attribute:status/Value:error' => '报错',
